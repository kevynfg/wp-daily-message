    ...
    if (msgCommand && msgCommand === "/sticker" && incomingMessage.id.remote.includes(GROUP_ID)) {
        ...
        if (incomingMessage.type === 'image') {
            try {
                ...
                if (!isMe) {
                    incomingMessage.reply(image, incomingMessage.id.id, {
                        sendMediaAsSticker: true,
                        stickerAuthor: 'Sticker generator do @wind',
                        stickerName: 'generated by @wind',
                    })
                } else {
                    await client.sendMessage(sender, image, {sendMediaAsSticker: true, stickerAuthor: 'Sticker generator do @wind', stickerName: 'generated by @wind'});
                }
            } catch (error) {
